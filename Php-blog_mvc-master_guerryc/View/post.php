    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <article>
                ...
                <h1 class="blue center"><?=htmlspecialchars($this->oPost->title)?></h1>
            ...
            <?php if(empty($_SESSION['is_user']) && empty($_SESSION['is_admin'])): ?>
                <a href="<?=ROOT_URL?>?p=blog&amp;a=login"><button class="btn black waves-effect waves-light">Se connecter pour commenter</button></a>
                <br><br>
            <?php else: ?>
                <h4>Commenter :</h4>
